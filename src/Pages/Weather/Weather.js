...
function WeatherApp() {
  ...
  return (
    ...
    <div className= {(typeof weather.main == "undefined") ? 'app' : (weather.weather[0].main == "Rain") ? 'app rain' 
          : (weather.weather[0].main == "Thunderstorm") ? 'app storm' : (weather.weather[0].main == "Snow") ? 'app cold' 
          : (weather.weather[0].main == "Clouds") ? 'app cloudy' : (weather.main.temp < 50) ? 'app cold-sunny' : 'app'}>
      <main>
